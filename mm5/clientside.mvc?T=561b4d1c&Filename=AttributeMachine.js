...
//
// $Id: AttributeMachine.js 27991 2012-02-21 23:04:53Z burch $
//
...
AttributeMachine_Radio.prototype.Cull = function( possible_option_lookup, selected_id )
{
	...
	for ( i = option_count = 0; i < this.options.length; i++ )
	{
		if ( possible_option_lookup[ this.options[ i ].id ] )	this.option_lookup[ this.options[ i ].id ].disabled	= false;
		else													this.option_lookup[ this.options[ i ].id ].disabled	= true;
	}
	...
	this.option_lookup[ selected_id ].checked	= true;
	return true;
}
